import 'lib/css'
import { defineAnimatedIconsPack } from 'lib/icons'
...
defineAnimatedIconsPack()

document.querySelector('body')!.innerHTML = `
<div class="heading-controls">
  <button id="prev" disabled>prev</button>
  <h1 class="heading">Cuil preview</h1>
  <button id="next" onclick="">next</button>
</div>

<div id="preview-container">
  <div class="tag-grid">
      <h2 class="page-title">Pure css styles</h2>
      <h3 class="category-title">Text Content</h3>
    ...
    return "world";
      ...
      <h3 class="category-title">Text Formatting</h3>
      ...
      <h3 class="category-title">Lists</h3>
      ...
      <h3 class="category-title">Links and Media</h3>
      ...
      <div class="tag-card">
          ...
          <div class="tag-example" style="display: flex; flex-direction: column; gap: .5rem">
      ...
      <h3 class="category-title">Form Input Types</h3>
  ...
  <div class="tag-grid">
      ...
      <h3 class="category-title">Animated icons</h3>

      <div class="tag-card">
          <div class="tag-name">eye</div>
          <div class="tag-description">Example use is show/hide sensitive content</div>
          <div class="tag-example">
            <cuil-animated-icon-eye id="eye-icon" />
          </div>
      </div>
      <div class="tag-card">
          <div class="tag-name">fullscreen</div>
          <div class="tag-description">Example use is toggle fullscreen view</div>
          <div class="tag-example">
            <cuil-animated-icon-fullscreen id="fullscreen-icon" />
          </div>
      </div>
  </div>
</div>
...
configureIconsPreview()

const maxPages = document.getElementById('preview-container')!.children.length
updatePosition()
...
function updatePosition() {
  ...
  ;(document.getElementById('prev') as HTMLButtonElement).disabled = currentPage === 0
  ;(document.getElementById('next') as HTMLButtonElement).disabled = currentPage === maxPages - 1

  Array.from(preview.children).forEach((child, index) => {
    if (child instanceof HTMLElement) {
      child.style.transform = `translateX(calc(${index - currentPage} * (100% + 2rem)))`
    }
  })
}

function configureIconsPreview() {
  const eyeIcon = document.querySelector('cuil-animated-icon-eye') as HTMLElement
  let eyeIsOpen = true
  eyeIcon.addEventListener('mousedown', () => {
    eyeIsOpen = false
    eyeIcon.setAttribute('state', 'closed')
  })
  eyeIcon.addEventListener('mouseup', () => {
    eyeIsOpen = true
    eyeIcon.setAttribute('state', 'opened')
  })
  ...
  const fullscreenIcon = document.querySelector('cuil-animated-icon-fullscreen') as HTMLElement
  let fullscreen = false
  fullscreenIcon.addEventListener('click', () => {
    fullscreen = !fullscreen
    fullscreenIcon.setAttribute('state', fullscreen ? 'maximized' : 'minimized')
  })
}
